...
int RunAction(GameAction *curraction)
{
    ...
    case ACTION_DRAWMENU:
        switch (curraction->Action)
        {
            ...
            case 2:
                DrawAward(0, 14, AWARD_SHITPANTSWHILEOFF, STRING_AWARD10NAME, STRING_AWARD10DESC);
                DrawAward(0, 17, AWARD_DONTSHIT, STRING_AWARD11NAME, STRING_AWARD11DESC);
                DrawAward(0, 21, AWARD_BELTSUSPENDERS, STRING_AWARD12NAME, STRING_AWARD12DESC);
